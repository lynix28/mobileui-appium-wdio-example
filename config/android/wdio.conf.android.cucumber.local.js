...
exports.config = {
	...
	specs: [
		...
		'../../tests/android/cucumber/features/*.feature'
	],
	// Patterns to exclude.
	exclude: [
	...
	cucumberOpts: {
		timeout: 60000,
		require: [
			'./tests/android/cucumber/steps/*.js'
		]
	},
	//
	// =====
	...
	// 	for (const capability of exports.config.capabilities) {
	// 		capability['appium:clearSystemFiles'] = true;
	// 	}
	// },
	/**
